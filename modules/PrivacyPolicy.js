  ...
  return (
    <div className={styles.outer}>
      <div className={styles.inner}>
        ...
        <p>
          HQ Records legal basis for collecting and using the personal
        ...
        <ul>
          <li>HQ Records needs to perform a contract with you</li>
          <li>You have given HQ Records permission to do so</li>
          <li>
            Processing your personal information is in HQ Records legitimate
            interests
          </li>
          <li>HQ Records needs to comply with the law</li>
        </ul>

        <p>
          HQ Records will retain your personal information only for as long as
        ...
        <p>
          www.hq-records.com follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, www.hq-records.com uses 'cookies'. These
        ...
        <p>
          ...
          advertising partners of www.hq-records.com.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on www.hq-records.com, which are
        ...
        <p>
          Note that www.hq-records.com has no access to or control over these
        ...
        <p>
          www.hq-records.com's Privacy Policy does not apply to other
        ...
        <p>
          www.hq-records.com does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in www.hq-records.com. This policy is not
